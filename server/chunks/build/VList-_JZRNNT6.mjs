import { shallowRef, ref, computed, readonly, toRef, createVNode, withDirectives, vShow, watch, mergeProps, Fragment, resolveDirective, TransitionGroup, Transition, h, camelize, inject, provide, toRaw } from 'vue';
import { q as defineComponent, p as propsFactory, I as IconValue, m as makeComponentProps, g as genericComponent, h as useRender, E as EventProp, s as makeThemeProps, t as provideTheme, v as deprecate, x as convertToUnit, z as provideDefaults, j as useProxiedModel, k as getCurrentInstance, l as consoleError, o as getUid, y as deepEqual, A as focusChild, w as wrapInArray, B as getPropertyFromItem, C as omit } from './server.mjs';
import { m as makeTagProps, a as makeDimensionProps, u as useDimension } from './dimensions-DxHl50uj.mjs';
import { M as MaybeTransition, c as createSimpleFunctional, e as VAvatar } from './VCard-C5tK0-Eq.mjs';
import { V as VDefaultsProvider, m as makeBorderProps, a as makeElevationProps, b as makeRoundedProps, k as makeRouterProps, l as makeVariantProps, R as Ripple, n as useLink, c as useBorder, o as useVariant, d as useElevation, e as useRounded, q as genOverlays, r as VIcon, s as useTextColor, u as useBackgroundColor } from './index-jC5fpk-_.mjs';
...
export { VList as V, VExpandTransition as a, VListItem as b, VListGroup as c, useSsrBoot as u };
//# sourceMappingURL=VList-_JZRNNT6.mjs.map
