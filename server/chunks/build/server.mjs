import { hasInjectionContext, inject as inject$1, version as version$1, unref, watch, onScopeDispose, Fragment, reactive, computed, watchEffect, toRefs, capitalize, shallowRef, warn, getCurrentInstance as getCurrentInstance$1, ref, provide, defineComponent as defineComponent$1, toRaw, createVNode, mergeProps, readonly, defineAsyncComponent, h, shallowReactive, Suspense, nextTick, Transition, effectScope, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, isReadonly, withCtx, isRef, isShallow, isReactive } from 'vue';
...
const unhead_ZnvzejoGqi = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-D1JlqIxi.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DyGmPQXq.mjs')
  },
  {
    name: "marketing",
    path: "/marketing",
    component: () => import('./marketing-CgRNGJEK.mjs')
  },
  {
    name: "passive",
    path: "/passive",
    component: () => import('./passive-Xqnc3PT5.mjs')
  },
  {
    name: "tenses-continuous",
    path: "/tenses/continuous",
    component: () => import('./continuous-C1PsT2Gm.mjs')
  },
  {
    name: "tenses-perfect-continuous",
    path: "/tenses/perfect-continuous",
    component: () => import('./perfect-continuous-CRbcTJ9m.mjs')
  },
  {
    name: "tenses-perfect",
    path: "/tenses/perfect",
    component: () => import('./perfect-ChvZLXqr.mjs')
  },
  {
    name: "tenses-simple",
    path: "/tenses/simple",
    component: () => import('./simple-CIZumV9M.mjs')
  },
  {
    name: "time-reference",
    path: "/time-reference",
    component: () => import('./time-reference-CNK-8mj2.mjs')
  },
  {
    name: "word-order",
    path: "/word-order",
    component: () => import('./word-order-RYX6jvRm.mjs')
  }
];
...
const revive_payload_server_bkXjwmMcrv = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_ZnvzejoGqi,
  plugin,
  revive_payload_server_bkXjwmMcrv,
  components_plugin_KR1HBZs4kY,
  vuetify_7h9QAQEssH
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-Ca15y3Jr.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BYVmjKfk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-vcepq5tE.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.2_@parcel+watcher@2.5.0_@types+node@22.10.7_db0@0.2.1_ioredis@5.4.2_magicast@0.3.5__hr46wuffbbw4ngbpuih62kj7hy/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.2_@parcel+watcher@2.5.0_@types+node@22.10.7_db0@0.2.1_ioredis@5.4.2_magicast@0.3.5__hr46wuffbbw4ngbpuih62kj7hy/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { matchesSelector as $, focusChild as A, getPropertyFromItem as B, omit as C, includes as D, EventProp as E, destructComputed as F, isCssColor as G, isParsableColor as H, IconValue as I, parseColor as J, getForeground as K, getCurrentInstanceName as L, useIcon as M, flattenFragments as N, clamp as O, hasEvent as P, isObject as Q, keyCodes as R, findChildrenWithProvide as S, consoleWarn as T, useResizeObserver as U, makeLayoutItemProps as V, useToggleScope as W, useLayoutItem as X, defer as Y, templateRef as Z, _export_sfc as _, resolveRouteObject as a, isClickInsideElement as a0, getNextElement as a1, focusableChildren as a2, makeDisplayProps as a3, useDisplay as a4, useLayout as a5, useRoute as a6, VApp as a7, __nuxt_component_1 as a8, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, breakpoints as e, useRtl as f, genericComponent as g, useRender as h, injectHead as i, useProxiedModel as j, getCurrentInstance as k, consoleError as l, makeComponentProps as m, nuxtLinkDefaults as n, getUid as o, propsFactory as p, defineComponent as q, resolveUnrefHeadInput as r, makeThemeProps as s, provideTheme as t, useRouter as u, deprecate as v, wrapInArray as w, convertToUnit as x, deepEqual as y, provideDefaults as z };
